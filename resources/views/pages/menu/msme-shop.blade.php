...
<head>
    ...
    <title>Toko UMKM — {{ env('APP_NAME') }}</title>
    ...
    <style>
        ...
        .stores-grid.list-view .sc-banner {
            width: 100px;
            min-width: 100px;
            height: auto;
            flex-direction: column;
        ...
        .stores-grid.list-view .sc-verified {
            display: none;
        }

        .stores-grid.list-view .sc-body {
            flex: 1;
            padding: 16px;
        ...
        .stores-grid.list-view .sc-footer {
            width: 180px;
            flex-shrink: 0;
            flex-direction: column;
            justify-content: center;
        ...
        .stores-grid.list-view .sc-divider,
        .stores-grid.list-view .sc-stats {
            display: none;
        }
            ...
            <div class="page-hero">
                ...
                <div class="hero-stats-strip">
                    <div class="hero-stat">
                        ...
                        <div class="lbl">Toko Aktif</div>
                    </div>
                    <div class="hero-stat">
                        <div class="num">38</div>
                        <div class="lbl">Kota / Kabupaten</div>
                    </div>
                    <div class="hero-stat">
                    ...
                    <div class="hero-stat">
                        ...
                        <div class="lbl">Respon WA &lt; 1 Jam</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="store-layout">
                ...
                <aside class="filter-sidebar">
                    <div class="filter-card">
                        <div class="filter-head">
                            <span><i class="fa-solid fa-sliders fa-sm"
                                    style="color:var(--primary);margin-right:6px;"></i>Filter</span>
                            <span class="filter-reset" onclick="clearFilters()">Reset</span>
                        </div>

                        <div class="filter-sec">
                            <div class="filter-sec-title">Kategori Toko <i class="fa-solid fa-chevron-up fa-xs"></i>
                            </div>
                            <div class="filter-opts">
                                <label class="filter-opt"><input type="checkbox" name="cat_filter" value="semua"
                                        onchange="sidebarCatChange(this)" checked> Semua Kategori <span
                                        class="filter-cnt">{{ $shops->count() }}</span></label>
                                @foreach ($categories as $cat)
                                    <label class="filter-opt"><input type="checkbox" name="cat_filter"
                                            value="{{ strtolower(str_replace(' ', '-', $cat)) }}"
                                            onchange="sidebarCatChange(this)"> {{ $cat }}</label>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="filter-sec">
                            ...
                            <div class="filter-opts" style="max-height:180px;overflow-y:auto;">
                                @foreach ($districts as $d)
                                    <label class="filter-opt"><input type="checkbox" value="{{ $d['name'] }}"
                        ...
                        <div class="filter-sec">
                            <div class="filter-sec-title">Status & Verifikasi <i
                                    class="fa-solid fa-chevron-up fa-xs"></i></div>
                            <div class="filter-opts">
                        ...
                        <div class="filter-sec">
                            <div class="filter-sec-title">Jumlah Produk <i class="fa-solid fa-chevron-up fa-xs"></i>
                            </div>
                            <div class="filter-opts">
                                ...
                                <label class="filter-opt"><input type="radio" name="prod"> 21 – 50
                                    produk</label>
                ...
                <main>
                    ...
                    <div class="featured-banner">
                        ...
                        <div class="fb-actions">
                            ...
                            <a href="#" class="btn btn-ghost btn-sm"
                                style="color:rgba(255,255,255,.6);">Pelajari →</a>
                        </div>
                    </div>
                    ...
                    <div class="cat-strip">
                        ...
                        @foreach ($categories as $cat)
                            <div class="tag"
                                onclick="filterCat(this, '{{ strtolower(str_replace(' ', '-', $cat)) }}')">
                                {{ $cat }}</div>
                        @endforeach
                    </div>
                    ...
                    <div class="store-topbar">
                        ...
                        <div class="topbar-right">
                            ...
                            <div class="view-toggle">
                                <button class="vtbtn active" id="btn-grid" onclick="setView('grid')"><i
                                        class="fa-solid fa-grip"></i></button>
                                <button class="vtbtn" id="btn-list" onclick="setView('list')"><i
    ...
    `).join('');
        ...
        function applyFilters() {
            ...
            filteredShops = SHOPS.filter(s => {
                ...
                if (searchQuery && !s.name.toLowerCase().includes(searchQuery) && !s.district.toLowerCase()
        ...
        function chatWA(name, wa) {
            @auth
            window.open(
                `https://wa.me/${wa}?text=${encodeURIComponent('Halo '+name+'! Saya menemukan toko kamu di PasarLokal.')}`,
                '_blank');
        @else
