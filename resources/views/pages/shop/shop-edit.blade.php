...
<body>
    ...
    <div class="container">
        <div class="wizard-layout" id="wizard-layout">
            ...
            <div id="wizard-form">
                        ...
                        <div class="form-block-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="shop-name"
                                    placeholder="Contoh: Dapur Bu Sari" maxlength="100" autocomplete="off"
                ...
                <div class="wizard-step" id="step-3">
                        ...
                        <div class="form-block-body">
                            <label
                                ...
                                <span>Saya menyatakan bahwa informasi yang saya berikan adalah benar dan saya
                                    menyetujui
                                    <a href="#" style="color:var(--primary);font-weight:600;">Syarat &
                                        Ketentuan</a>
                                    serta
                    ...
                    <div class="wizard-nav">
                        ...
                        <div class="wizard-nav-right">
                            <button id="btn-submit" class="btn btn-primary btn-lg" style="min-width:180px;"
                                onclick="submitShop(event)">
            ...
            <aside class="sidebar-sticky" id="wizard-sidebar">
                ...
                <div class="progress-widget">
                    ...
                    <div class="pw-step">
                        <div class="pw-dot active" id="pw0">1</div><span class="pw-label active"
                            id="pwl0">Info
                            Toko</span>
                    </div>
                    <div class="pw-step">
                        <div class="pw-dot" id="pw1">2</div><span class="pw-label" id="pwl1">Logo &
                            Kontak</span>
                    </div>
                    <div class="pw-step">
                        <div class="pw-dot" id="pw2">3</div><span class="pw-label"
                            id="pwl2">Alamat</span>
                    </div>
                    <div class="pw-step">
                        <div class="pw-dot" id="pw3">4</div><span class="pw-label" id="pwl3">Review &
                            Submit</span>
                    </div>
                </div>
        ...
        <div class="success-screen" id="success-screen">
            ...
            <p>
                Perubahan data toko <strong id="success-name" style="color:var(--primary);"></strong> telah berhasil
                disimpan.
            </p>
            <div class="success-actions">
                <a href="{{ route('shop.manage') }}" class="btn btn-primary btn-lg"><i
                        class="fa-solid fa-store"></i> Kembali ke Dashboard</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function updateStepperUI(prev, next) {
            for (let i = 0; i < TOTAL_STEPS; i++) {
                ...
                if (i < next) {
                    ...
                    pw.classList.add('done');
                    pwl.classList.add('done');
                    pw.innerHTML = '✓';
                } else if (i === next) {
                    si.classList.add('active');
                    pw.classList.add('active');
                    pwl.classList.add('active');
                    pw.textContent = i + 1;
                } else {
                    pw.textContent = i + 1;
                }
        ...
        function countChars(el, countId, max) {
            ...
            cnt.className = 'char-count' + (el.value.length > max * 0.9 ? ' warn' : '') + (el.value.length >= max ?
                ' over' : '');
        }
        ...
        function submitShop(event) {
            if (!document.getElementById('tos-check').checked) {
                toast('⚠️ Centang persetujuan syarat & ketentuan terlebih dahulu.', 'error');
                return;
            }
            ...
            // Final check
            if (!formData.name || !formData.slug || !formData.whatsapp_number || !formData.address || !formData
                .district_name) {
                toast('⚠️ Ada data wajib yang belum diisi. Periksa kembali.', 'error');
                return;
            }
        ...
        function toast(msg, type = 'success') {
            ...
            el.innerHTML = (type === 'success' ? '<i class="fa-solid fa-circle-check"></i> ' :
