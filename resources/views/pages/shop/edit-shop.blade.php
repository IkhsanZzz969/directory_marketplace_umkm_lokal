    ...
    <body>
        ...
        <div class="page-top">
            <div class="container">
                <div class="page-hero-inner">
                    <div class="ph-left">
                        <h1 class="font-display">Edit Toko Anda</h1>
                        <p>Perbarui informasi toko UMKM Anda agar pelanggan lebih mudah mengenali dan berbelanja.</p>
                    </div>
                    <div class="ph-right">
        ...
        <div class="container">
                ...
                <div id="wizard-form">
                    ...
                    <div class="wizard-step active" id="step-0">
                            ...
                            <div class="form-block-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="shop-name"
                                        placeholder="Contoh: Dapur Bu Sari" maxlength="100" autocomplete="off" value="{{ old('name', $shop->name ?? '') }}">
                                ...
                                <div class="form-group" style="margin-bottom:0;">
                                    ...
                                    <div class="input-pre-wrap">
                                        ...
                                        <input type="text" class="form-control" id="shop-slug"
                                            placeholder="dapur-bu-sari" maxlength="120" autocomplete="off" value="{{ old('slug', $shop->slug ?? '') }}">
                                    </div>
                                    <div class="field-footer">
                        ...
                        <div class="form-block">
                            ...
                            <div class="form-block-body">
                                <div class="form-group" style="margin-bottom:0;">
                                    <label class="form-label">Deskripsi Toko (Bio) <span
                                            style="color:var(--dark-light);font-weight:400;">(Opsional)</span></label>
                                    <textarea class="form-control" id="shop-desc" rows="4" maxlength="500"
                                        placeholder="Ceritakan singkat tentang toko Anda, keunggulan produk, atau sejarah berdirinya...">{{ old('description', $shop->description ?? '') }}</textarea>
                                    <div class="field-footer">
                        ...
                        <div class="form-block">
                            ...
                            <div class="form-block-body">
                                <div class="form-group" style="margin-bottom:0;">
                                    ...
                                    <select class="form-control" id="shop-cat" data-selected="{{ $shop->category ?? '' }}">
                                        <option value="">— Pilih Kategori Toko —</option>
                                        <option value="Makanan & Minuman" {{ ($shop->category ?? '') == 'Makanan & Minuman' ? 'selected' : '' }}>🍔 Makanan & Minuman</option>
                                        <option value="Kerajinan Tangan" {{ ($shop->category ?? '') == 'Kerajinan Tangan' ? 'selected' : '' }}>🧶 Kerajinan Tangan</option>
                                        <option value="Fashion & Aksesoris" {{ ($shop->category ?? '') == 'Fashion & Aksesoris' ? 'selected' : '' }}>👗 Fashion & Aksesoris</option>
                                        <option value="Kebutuhan Rumah Tangga" {{ ($shop->category ?? '') == 'Kebutuhan Rumah Tangga' ? 'selected' : '' }}>🏡 Kebutuhan Rumah Tangga</option>
                                        <option value="Agrikultur & Hasil Bumi" {{ ($shop->category ?? '') == 'Agrikultur & Hasil Bumi' ? 'selected' : '' }}>🌾 Agrikultur & Hasil Bumi</option>
                                        <option value="Lainnya" {{ ($shop->category ?? '') == 'Lainnya' ? 'selected' : '' }}>✨ Lainnya</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="wizard-step" id="step-1">
                        ...
                        <div class="form-block">
                            ...
                            <div class="form-block-body">
                                ...
                                <input type="hidden" id="shop-logo" value="{{ $shop->logo ?? '' }}">
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-pre-wrap">
                                        ...
                                        <input class="form-control" id="shop-wa" type="tel" placeholder="812-3456-7890"
                                            maxlength="15" oninput="onWAInput(this.value)" value="{{ old('whatsapp_number', $shop->whatsapp_number ?? '') }}">
                                    </div>
                                    <div class="field-footer">
                        ...
                        <div class="form-block">
                            ...
                            <div class="form-block-body">
                                <div class="form-group" style="margin-bottom:0;">
                                    ...
                                    <textarea class="form-control" id="shop-address" rows="3" maxlength="300"
                                        placeholder="Nama jalan, nomor bangunan, RT/RW, dsb...">{{ old('address', $shop->address ?? '') }}</textarea>
                                    <div class="field-footer">
                    ...
                    <div class="wizard-step" id="step-3">
                        ...
                        <div class="wizard-nav">
                            <div class="wizard-nav-left">
                                <button class="btn btn-outline" style="min-width:140px;"
                                        onclick="goStep(2)">Kembali</button>
                            </div>
                            <div class="wizard-nav-right">
                                <button id="btn-submit" class="btn btn-primary btn-lg" style="min-width:180px;" onclick="submitShop(event)">
            ...
            <div class="success-screen" id="success-screen">
                ...
                <h2>Toko Berhasil Diperbarui!</h2>
                <p>
                    Perubahan data toko <strong id="success-name" style="color:var(--primary);"></strong> telah berhasil disimpan.
                </p>
                <div class="success-actions">
                    <a href="{{ route('kelola-toko') }}" class="btn btn-primary btn-lg"><i class="fa-solid fa-store"></i> Kembali ke Dashboard</a>
                </div>
            </div>
        </div>
