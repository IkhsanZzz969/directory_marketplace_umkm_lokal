...
<head>
    ...
    <title>Buat Toko — {{ env('APP_NAME') }}</title>
...
<body>
    ...
    <div class="container">
                        ...
                        <div class="form-block-body">
                            ...
                            <div class="form-group" style="margin-bottom:0;">
                                ...
                                <div class="input-pre-wrap">
                                    <div class="input-pre">laba.web.id/toko/</div>
        ...
        <div class="success-screen" id="success-screen">
            ...
            <div class="success-actions">
                <a href="{{ route('profile') }}" class="btn btn-ghost btn-lg"
                    style="border:1.5px solid var(--border);">Ke
                    Profil</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function renderDistricts(data) {
            ...
            if (data.length === 0) {
                grid.innerHTML =
                    '<div style="grid-column:1/-1;text-align:center;padding:20px;color:var(--dark-light);font-size:.82rem;"><i class="fa-solid fa-magnifying-glass"></i> Pilih Kecamatan</div>';
                return;
            }
        ...
        function searchDistrict(q) {
            if (!q.trim()) {
                filterByCity(document.getElementById('city-select').value);
                return;
            }
