        ...
        <div class="container">
            <div class="hero-inner">
                <div class="hero-content reveal">
                    ...
                    <p class="lead">Laba menghubungkan kamu langsung dengan ribuan pelaku UMKM terpercaya. Pesan lewat
                        WhatsApp — mudah, cepat, tanpa perantara.</p>
                ...
                <div class="hero-visual reveal" style="transition-delay:.2s">
                    <div class="hero-visual-main">
                        <div class="hero-visual-header">
                            ...
                            <span
                                style="color:rgba(255,255,255,0.5);font-size:0.75rem;margin-left:8px;">pasarBanyumas.id/catalog</span>
                        </div>
                    ...
                    <div class="float-badge float-badge-1">
                        ...
                        <div>
                            ...
                            <div style="font-weight:400;color:var(--dark-light);font-size:0.7rem;">Langsung ke penjual
                            </div>
                        </div>
                    </div>
    ...
    <section class="how-section">
        <div class="container">
            <div class="section-header center reveal">
                ...
                <p style="color:rgba(255,255,255,0.6);">Tidak perlu daftar untuk berbelanja. Pilih produk, hubungi
                    penjual, dan deal!</p>
            </div>
            <div class="grid-3 reveal" style="transition-delay:.15s">
                <div class="how-card">
                    ...
                    <p>Jelajahi ribuan produk UMKM Banyumas. Filter berdasarkan kategori, kota, atau harga sesuai
                        kebutuhan kamu.</p>
                </div>
                <div class="how-card">
                    ...
                    <h3>Chat Langsung</h3>
                    <p>Klik tombol WhatsApp untuk langsung ngobrol dengan pemilik toko. Tanya-tanya, nego harga, atau
                        konfirmasi stok.</p>
                </div>
                <div class="how-card">
                    ...
                    <h3>Deal & Nikmati</h3>
                    <p>Sepakati pengiriman dan pembayaran langsung dengan penjual. Dukung UMKM Banyumas dengan setiap
                        pembelian kamu!</p>
                </div>
            </div>
        </div>
            ...
            <div class="grid-4 reveal" style="transition-delay:.1s">
                ...
                <div class="product-card" onclick="location.href='/product-detail'">
                    <div class="product-card-img">
                        <div
                            style="width:100%;height:100%;background:linear-gradient(135deg,#fef3c7,#fed7aa);display:flex;align-items:center;justify-content:center;font-size:3rem;">
                            🍪</div>
                    ...
                    <div class="product-card-actions">
                        <button class="btn btn-wa w-full btn-sm"><i class="fa-brands fa-whatsapp"></i> Pesan
                            WA</button>
                    </div>
                </div>
                <div class="product-card" onclick="location.href='/product-detail'">
                    <div class="product-card-img">
                        <div
                            style="width:100%;height:100%;background:linear-gradient(135deg,#dbeafe,#bfdbfe);display:flex;align-items:center;justify-content:center;font-size:3rem;">
                            🎨</div>
                ...
                <div class="product-card" onclick="location.href='/product-detail'">
                    <div class="product-card-img">
                        <div
                            style="width:100%;height:100%;background:linear-gradient(135deg,#d1fae5,#a7f3d0);display:flex;align-items:center;justify-content:center;font-size:3rem;">
                            🍯</div>
                    </div>
                    <div class="product-card-body">
                ...
                <div class="product-card" onclick="location.href='/product-detail'">
                    <div class="product-card-img">
                        <div
                            style="width:100%;height:100%;background:linear-gradient(135deg,#ede9fe,#ddd6fe);display:flex;align-items:center;justify-content:center;font-size:3rem;">
                            👜</div>
            ...
            <div class="grid-4 reveal" style="transition-delay:.1s">
                ...
                <div class="shop-card">
                    ...
                    <div class="shop-card-body">
                        ...
                        <div class="shop-card-district"><i class="fa-solid fa-location-dot"></i> Kotagede, Yogyakarta
                        </div>
                        <div class="shop-card-stats">
    ...
    <section class="section-sm">
        <div class="container reveal">
            <div class="promo-banner">
                <div>
                    <h2>Punya UMKM? Daftarkan Toko Kamu <em
                            style="font-style:normal;color:var(--primary);">Gratis!</em></h2>
                    <p>Jangkau lebih banyak pelanggan tanpa biaya. Daftar sekarang dan mulai berjualan dalam 5 menit.
                    </p>
                </div>
                <div class="promo-actions">
                    ...
                    <a href="/auth" class="btn btn-ghost btn-lg" style="color:rgba(255,255,255,0.7);">Pelajari
                        Lebih Lanjut</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="grid-3 reveal" style="transition-delay:.1s">
                <div class="testi-card">
                    ...
                    <p class="testi-text">Sejak daftar di PasarBanyumas, omzet nastar saya naik 3x lipat di musim
                        Lebaran. Pembelinya dari mana-mana, bukan cuma tetangga!</p>
                ...
                <div class="testi-card">
                    <div class="testi-quote">"</div>
                    <p class="testi-text">Saya suka banget ada tombol WhatsApp langsung. Nggak perlu repot buat akun,
                        tinggal chat dan deal. Simpel dan nggak ribet!</p>
                    <div class="testi-author">
                ...
                <div class="testi-card">
                    <div class="testi-quote">"</div>
                    <p class="testi-text">Platform ini membantu saya ekspansi penjualan batik ke luar Jawa. Tampilannya
                        keren, dan tim support-nya super responsif!</p>
                    <div class="testi-author">
        ...
        <div class="container">
            <div class="grid-4" style="gap:40px;align-items:start;">
                <div style="grid-column:span 1">
                    ...
                    <p style="margin-bottom:20px;line-height:1.8;">Platform digital yang menghubungkan UMKM Banyumas
                        dengan pembeli di seluruh Banyumas.</p>
