...
class MenuController extends Controller
{
    ...
    {
        $shops = \App\Models\Shop::withCount('products')->where('is_active', true)->latest()->get();
        
        $categories = ['Makanan & Minuman', 'Kerajinan', 'Fashion', 'Pertanian', 'Jasa', 'Lainnya'];
        ...
        return view('pages.menu.msme-shop', compact('shops', 'categories', 'districts'));
    }
}
